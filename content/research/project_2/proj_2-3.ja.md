...
<!--{{< figure src="/images/research/proj_2-3-1.jpg" alt="図：ML/MMモデルの概略図" caption="図：QM/MM境界における複雑な相互作用を学習するML/MMモデルの概略図。" >}}-->

### 参考文献
1. Lei, Y.-K., Yagi, K., and Sugita, Y. J. Chem. Phys. 160, 214109 (2024). https://doi.org/10.1063/5.0205123

1. Lei, Y.-K., Yagi, K., and Sugita, Y. J. Chem. Theory Comput. 21, 2695 (2024). https://doi.org/10.1021/acs.jctc.4c01393
