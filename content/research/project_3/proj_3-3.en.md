...
<div style="text-align: center;"> {{< figure src="/images/research/proj_3-3-1.jpg" alt="" caption="Figure 1: Dimerization of APP-C99 and four key reaction coordinates" class="center" >}} </div>
...
<div style="text-align: center;"> {{< figure src="/images/research/proj_3-3-2.jpg" alt="" caption="Figure 2: Free-energy landscapes of APP-C99 and three stable dimer conformations" class="center" >}} </div>
