...
<article class="article-block accordion-block">
  <h3 class="accordion-trigger">Unbiased structure assignment of peptide conformers: application of similarity scores to Ace-AA-O-Bzl vibrational spectra</h3>
  <div class="author">Hiroki Otaki, Yuji Sugita, Kiyoshi Yagi</div>
  <div class="journal-link">
    <a href="https://www.sciencedirect.com/science/article/pii/S030101042600296X" target="_blank" rel="noopener noreferrer">
    <em>Chem. Phys.</em> <strong>611</strong>, 113373 (2026).</a></div>
  <div class="detail accordion-body">
  Vibrational spectroscopy is a valuable tool for elucidating the structure and interaction of polypeptides at atomistic level. Although the atomistic structure is assigned by comparing experimental spectra with computed spectra of candidate conformers, the comparison performed with visual inspection becomes a challenge, requiring much knowledge and experience on spectral assignments. To overcome this issue, we have recently proposed an efficient conformational search scheme along with similarity scores, which quantify a spectral agreement [H. Otaki et al., Phys. Chem. Chem. Phys. 26 (2024) 9906–9914]. In this study, we apply the method to a capped dipeptide, N-acetyl-(Ala)2-O-benzyl. The present calculation has identified two conformers, whose structures are consistent with the previous experimental work [E. Gloaguen et al., J. Am. Chem. Soc. 132 (2010) 11860–11863]. This study demonstrates the utility of our conformational search scheme and similarity scores in facilitating the assignment of atomistic structures, while reducing reliance on purely subjective visual inspection.
  </div>
</article>

<article class="article-block accordion-block">
  <h3 class="accordion-trigger">Structural analysis of a motor with increased mechanical output reveals new transitions in kinesin microtubule motility</h3>
  <div class="author">Satoki Shibata, Matthew Y. Wang, Tsuyoshi Imasaki, Hideki Shigematsu, Diego Ugarte La Torre, Yuanyuan Wei, Chacko Jobichen, Hajime Hagio, J. Sivaraman, Yuji Sugita, Sharyn A. Endow, Ryo Nitta</div>
  <div class="journal-link"><a href="https://www.nature.com/articles/s41598-025-28573-7" target="_blank" rel="noopener noreferrer"><em>Sci. Rep.</em> <strong>16</strong>, 487 (2026).</a></div>
  <div class="detail accordion-body">
...
<article class="article-block accordion-block">
  ...
  <div class="journal-link">
    ...
    <em>Biophys. J.</em> <strong>125</strong>, 581–593 (2026).</a></div>
  <div class="detail accordion-body">
...
<article class="article-block accordion-block">
  ...
  <div class="journal-link"><a href="https://doi.org/10.1021/acs.jctc.5c00163" target="_blank" rel="noopener noreferrer"><em>J. Chem. Theory Comput.</em> <strong>21</strong>, 8, 4016–4029 (2025).</a></div>
  <div class="detail accordion-body">
...
<article class="article-block accordion-block">
  ...
  <div class="journal-link"><a href="https://doi.org/10.1021/acs.jctc.4c01393" target="_blank" rel="noopener noreferrer"><em>J. Chem. Theory Comput.</em> <strong>21</strong>, 5, 2695–2711 (2025).</a></div>
  <div class="detail accordion-body">
...
<article class="article-block accordion-block">
  ...
  <div class="journal-link"><a href="https://onlinelibrary.wiley.com/doi/abs/10.1002/jcc.27260" target="_blank" rel="noopener noreferrer"><em>J. Comput. Chem. </em> <strong>45</strong>,(8) 498-505(2024)</a></div>
  <div class="detail accordion-body">
